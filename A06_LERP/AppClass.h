...
class AppClass : public ReEngAppClass
{
	...
	matrix4 *sphereMatrixes = nullptr;
	double timeJourney = 0;
	vector3 start;
	vector3 end;
	float lerpPercent = 0;
public:
	...
	*/
	...
	/*
	My custom lerp function because glm::lerp was giving me nonsensical numbers
	*/
	virtual vector3 Lerp(vector3 start, vector3 end, float percent) final;
};
